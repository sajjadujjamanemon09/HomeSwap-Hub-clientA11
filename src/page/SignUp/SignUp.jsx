...
const SignUp = () => {
  ...
  const {createUser, logOut} = useContext(AuthContext)
    ...
    <div className="text-center">
      <h1 className="text-5xl font-bold pt-8">Need Some Service? Sign Up Now !</h1>
      </div>
      ...
      <p className="text-center pb-4">Already have an Account <Link className="text-blue-600 font-bold" to='/signIn'>Sign In</Link> </p>
    </div>
  </div>
</div>
</Container>
